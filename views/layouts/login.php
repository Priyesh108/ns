...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="<?php echo Yii::getAlias('@web') ?>/plugins/bootstrap/dist/css/bootstrap.min.css">
    <!-- Font Awesome -->
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo Yii::getAlias('@web') ?>/plugins/iCheck/square/blue.css">
...
<!-- iCheck -->
<script src="<?php echo Yii::getAlias('@web') ?>/plugins/iCheck/icheck.min.js"></script>
<script>
    $(function () {
        $('input').iCheck({
